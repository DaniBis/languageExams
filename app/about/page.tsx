...
const aboutCopy: Record<Locale, {
  ...
  en: {
      ...
      columns: [
        {
          ...
          items: [
            ...
            '• Over 5 years teaching English online and in-person',
          ],
        },
        {
    ...
    proofs: {
      heading: 'Exam results & proof',
      body:
        'Here are real snippets from students who trusted the process—official IELTS and Cambridge confirmations that reflect the consistency of our work together.',
      items: [
        {
  ...
  ro: {
      ...
      columns: [
        {
          ...
          items: [
            ...
            '• Peste 5 ani de experienta online si fata in fata',
          ],
        },
        {
    ...
    proofs: {
      heading: 'Rezultate si dovezi',
      body:
        'Cateva exemple reale de rapoarte IELTS si Cambridge obtinute de cursanti cu care am lucrat – confirmari oficiale ca metodologia functioneaza.',
      items: [
        {
